...
with open(file_to_load) as election_data:
    ...
    for row in file_reader:
        ...
        if candidate_name not in candidate_options:
            ...
            #Add candidate name to candidate_options list 
...
# Determine the percentages of votes for each candidate by looping through the counts
